...
/**
 * Basic maze router for routing inter-site nets.
 * Using Lee-Algorithm
 * Created on: Sep 21, 2020
 */
public class mazeRouter extends AbstractRouter {
    ...
    public mazeRouter(Design design){
        super();
        this.design = design;
    ...
    public void routeNet(){
        ...
        for(SitePinInst currPin : currNet.getPins()){
            ...
            if(firstSinkToRouteInNet){
                ...
                getSourcesFromPIPs(pipList, currSources/* TODO - prune this list to make it faster*/);//(TODO - to create a maze)
            }
