...
/**
 * pathfinder
 * comes from maze router
 */
public class newPathfinder extends AbstractRouter {
    ...
    public newPathfinder(Design design){
        super();
        this.design = design;
    ...
    public static void main(String[] args) {
        ...
        newPathfinder r = new newPathfinder(Design.readCheckpoint(args[0],t));
